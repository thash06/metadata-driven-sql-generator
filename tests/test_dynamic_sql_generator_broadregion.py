...
TABLE_NAME = 'EDW_SANDBOX_DB.EDW_SANDBOX_RDS.BROAD_REGION'

STAGE_DATA_FIELDS = 'select parse_json($1):uuid as CRM_BROAD_REGION_ID, parse_json($1):value as ' \
                    'BROAD_REGION_NAME from @edw_stage_data/broad-region.json (file_format => json_format)'

IDENTIFIER_COL = 'BROAD_REGION_ID'

COLUMN_NAMES = 'BROAD_REGION_NAME, CRM_BROAD_REGION_ID'

COLUMN_NAMES_WITH_SS = 'SS.BROAD_REGION_NAME, SS.CRM_BROAD_REGION_ID'

COLUMN_NAMES_WITH_VALUE = 'BROAD_REGION_NAME, CRM_BROAD_REGION_ID'

COLUMN_NAMES_WITH_ALIAS = 'S.BROAD_REGION_NAME, S.CRM_BROAD_REGION_ID'

FOREIGN_KEY_COLS = ''

TIMESTAMP_COLUMNS = 'INSERT_UTC_DATETIME, START_DATETIME, END_DATETIME'

HASH_KEY_COLS = 'select hash(SS.BROAD_REGION_NAME, SS.CRM_BROAD_REGION_ID) as source_key'
...
def dynamic_statement_generator():
    return DynamicStatementGenerator('@edw_stage_data/broad-region.json', 'broad-region', True)
